...
def score_color_change(sc, sp):
	if sp > sc:
		you_score.configure(fg = 'green', text = '{} 😊'.format(sp))
		comp_score.configure(fg = 'red', text = '{} 😞'.format(sc))
	elif sp < sc:
		you_score.configure(fg = 'red', text = '{} 😞'.format(sp))
		comp_score.configure(fg = 'green', text = '{} 😊'.format(sc))
	elif sp == sc:
		you_score.configure(fg = 'blue', text = '{} 😔'.format(sp))
		comp_score.configure(fg = 'blue', text = '{} 😔'.format(sc))
...
rock = Button(root, text = "Rock ✊", font = ('Verdana', 16), command = rock, bg = 'blue',width = 9)
paper = Button(text = "Paper ✋", font = ('Verdana', 16), command = paper, bg = 'red',width = 9)
scissor = Button(text = "Scissor ✌", font = ('Verdana', 16), command = scissor, bg = 'green',width = 9)
...
reset = Button(text = "Reset", font = ('Verdana',16), command = reset, bg = 'magenta',width = 45)
random = Button(text = 'Random', font = ('Verdana', 16), bg = 'orange', width = 45, command = random)
